package org.sleepless_artery.assignment_service.config.kafka.properties;
 ...
 * <p>
 * Loaded from {@code spring.kafka.consumer} prefix.
 */
@Configuration
...
public class KafkaConsumerConfigProperties {
    ...
    private String trustedPackages = "org.sleepless_artery.assignment_service.*";
}
