package org.sleepless_artery.assignment_service.config.kafka;

import lombok.RequiredArgsConstructor;
import org.apache.kafka.clients.admin.NewTopic;
import org.apache.kafka.common.config.TopicConfig;
import org.sleepless_artery.assignment_service.config.kafka.properties.KafkaTopicConfigProperties;
...
/**
 * Kafka topic configuration for the assignment domain.
 *
 * <p>Responsible for creating Kafka topics.
 ...
 * <p>Example:</p>
 * <pre>
 * assignment.assignments.deleted
 * </pre>
 *
...
public class KafkaTopicConfig {
    ...
    /**
     * Creates Kafka topic for assignment deletion events.
     *
     * @return configured {@link NewTopic} instance
     */
    @Bean
    public NewTopic assignmentDeletedTopic() {
