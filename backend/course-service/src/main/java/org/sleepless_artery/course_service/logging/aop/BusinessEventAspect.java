package org.sleepless_artery.course_service.logging.aop;
 ...
 * Extracts key fields from method arguments: id, title, authorId.
...
public class BusinessEventAspect {
    ...
    private Map<String, Object> extractBusinessContext(ProceedingJoinPoint joinPoint) {
        ...
        for (var arg : joinPoint.getArgs()) {
            ...
            extractField(context, arg, "title");
            extractField(context, arg, "authorId");
        }
