package org.sleepless_artery.submission_service.exception.handler;

import lombok.extern.slf4j.Slf4j;
import org.sleepless_artery.submission_service.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleConflict(SubmissionAlreadyExistsException ex) {
        return buildErrorResponse(
                HttpStatus.CONFLICT,
                ex.getMessage(),
                null
    ...
    public ResponseEntity<Object> handleBadRequest(UnsupportedFileTypeException ex) {
        return buildErrorResponse(
