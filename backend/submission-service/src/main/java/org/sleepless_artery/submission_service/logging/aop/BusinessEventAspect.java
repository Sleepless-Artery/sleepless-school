 ...
 * Extracts key fields from method arguments: id, assignmentId, studentId, fileKey, displayFilename.
...
public class BusinessEventAspect {
     ...
     * Fields: id, assignmentId, studentId, fileKey, displayFilename.
     */
    private Map<String, Object> extractBusinessContext(JoinPoint joinPoint) {
        ...
        for (var arg : joinPoint.getArgs()) {
            ...
            extractIfPresent(ctx, arg, "assignmentId");
            extractIfPresent(ctx, arg, "studentId");
     ...
     */
    private void extractIfPresent(Map<String, Object> context, Object arg, String field) {
        try {
            var f = arg.getClass().getDeclaredField(field);
            f.setAccessible(true);
            var v = f.get(arg);
            if (v != null) context.put(field, v);
